						...
						<div class="flex space">
							<div class="col-1">
								<div>
									...
									<label for="telefon">Email</label><input type="text" name="email" id="email" value="<?php if(!empty($valueEmail)){ echo "$valueEmail"; }?>">
								...
								<div class="flex">
									<select name="sort-by" id="sort-by" required="required" class="per100">
										<option value="tradesman.id_company">ID</option>
										<option value="company.nazev" selected="select">Firma</option>
										<option value="tradesman.prijmeni">Příjmení</option>
										<option value="tradesman.telefon">Telefon</option>
										<option value="tradesman.email">Email</option>
										<option value="tradesman.stat">Stát</option>
									</select>
								...
								<div>
									<input type="radio" <?php //if ($valuePriceType == "dohoda") { echo "checked=\"checked\""; } ?> name="filled" value="splneno-vse" id="splneno-vse"><label for="splneno-vse" class="check-2">Aktivní i&nbsp;neaktivní</label>	
									<input type="radio" checked="checked" <?php //if ($valuePriceType == "ico") { echo "checked=\"checked\""; } ?> name="filled" value="splneno-ano" id="splneno-ano"><label for="splneno-ano" class="check-2">Aktivní</label>
