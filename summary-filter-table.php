				...
				switch ($choose[$j]) {
					...
					case 'trzba':
						...
						for ($f=0; $f < $counterProductHeader; $f++) {
							...
							//	$productPriceArray[1] = 0;
							//}


							if (empty($productArray[1])) {
								$productArray[1] = 0;
							}
							...
							//$trzbaCelkemVypocet += $productPriceArray[1] * $productArray[4];
							
							$trzbaCelkemVypocet += $productArray[1] * $productArray[4];

						}

						$trzbaCelkemVypocet += $rowProduct[42];

						echo "
						<td>$trzbaCelkemVypocet</td>";
					...
					case 'photo':
						...
						if (!empty($row1[$i])) {
							...
							$name4 = explode("/", $row1[$i+3]);
							$name5 = explode("/", $row1[$i+4]);
							...
							if ($row1[$i+3]=="Array" || empty($row1[$i+3])) {
								$show4 = $row1[$i+3] = "/images/none.png";
								$name4[5] = "Nenahraná";
							}
							else {
								$show4 = "/images/show.png";
							}
							if ($row1[$i+4]=="Array" || empty($row1[$i+4])) {
								$show5 = $row1[$i+4] = "/images/none.png";
								$name5[5] = "Nenahraná";
							}
							else {
						 ...
						 ?>
							...
							<td><a href="<?php echo $row1[$i+3]; ?>" data-lightbox="akce-<?php echo "$counterCykl"; ?>" data-title="<?php echo "$name4[5]"; ?>"><img src="<?php echo $show4; ?>" height="50px" alt="Náhled" title="Klikni pro zvětšení"></a></td>
							<td><a href="<?php echo $row1[$i+4]; ?>" data-lightbox="akce-<?php echo "$counterCykl"; ?>" data-title="<?php echo "$name5[5]"; ?>"><img src="<?php echo $show5; ?>" height="50px" alt="Náhled" title="Klikni pro zvětšení"></a></td>
