...
<table id="produkty">
						...
						for ($i=0; $i <= 39; $i++) {
							...
							<tr>";?>
								<?php
									echo "
								<td class=\"bold\">";?><input type="text" class="invisible display-none" name="<?php echo "$produktTemp"; ?>" id="<?php echo "$produktTemp"; ?>" value="<?php echo "${$prodNazevTemp}"; ?>" <?php //echo "$disabledProduct-1"; ?>><?php echo "${$prodNazevTemp}";?></td> 
								<?php 
								...
								<?php 
									...
									else { ?><td><input type="number" step="any" class="invisible display-none" name="<?php echo "$produktTemp"; ?>" value="<?php echo "${$prodPocTemp}"; ?>"><?php echo ${$prodPocTemp}?>&nbsp;Ks</td> 
									<?php }
								?>
								<?php 
									...
									<?php } 
									else { ?><td><input type="number" step="any" class="invisible display-none" name="<?php echo "$produktTemp"; ?>" value="<?php echo "${$prodKonecTemp}"; ?>"><?php echo ${$prodKonecTemp}?>&nbsp;Ks</td> 
									<?php }
								?>
								<?php 
									...
									} else { ?><td><input type="number" step="any" class="invisible display-none" name="<?php echo "$produktTemp"; ?>" value="<?php echo "${$prodKusuTemp}"; ?>"><?php echo ${$prodKusuTemp}?>&nbsp;Ks</td> 
									<?php }
								?>
							<?php echo "
							</tr>";
