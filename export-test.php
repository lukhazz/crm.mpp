		...
		<div class="col-md-12 column">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<form action="export-test.php" method="post" id="export-form">
	                 ...
	                 <table id="" class="table table-striped table-bordered">
		                ...
		                <tbody>
						  ...
						  <tr>
						  <td>DATA<?php //echo $row ['Name']?></td>
						  <td>DATA<?php //echo $row ['Status']?></td>
						  <td>DATA<?php //echo $row ['Priority']?></td>
						  <td>DATA<?php //echo $row ['Salary']?></td>
						  </tr>
						  <?php //endforeach; ?>
		                </tbody>
	              	</table>
