				...
				<div id="wrapper">
					<section class="form">
						...
						<form action="<?php $_SERVER['PHP_SELF'] ?>" method="post" name="register" class="clearfix">
							...
							<?php //$timeArray[0] = $timeArray[1] = $timeArray[2] = $timeArray[3] = $id = $pharmacy = $usersKoo = $form = $users = $company = $status = $goal = $time = $pause = $tradesman = $hours = ""; $bonus = 200; ?>
							<?php $status = $id = ""; ?>
