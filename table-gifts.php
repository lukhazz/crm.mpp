...
<table id="darky">
						...
						for ($i=0; $i <= 20; $i++) { 
							...
							<tr>";
								echo "
								<td>";?><input type="text" id="<?php echo "$darekTemp"; ?>" name="<?php echo "$darekTemp"; ?>" class="display-none" value="<?php echo removeSqlShowChar($gift[0]); ?>"><?php echo removeSqlShowChar($gift[0]); ?></td>
								<?php 
